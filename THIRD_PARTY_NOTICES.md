...
The repository's GitHub Actions workflows use GitHub's official `actions/checkout`, `actions/attest`, and `actions/upload-artifact` actions pinned to specific commits. GitHub-hosted runner software and Apple/Xcode toolchains are provided by their respective vendors under their own terms.
