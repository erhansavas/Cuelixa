...
Cuelixa 0.7.2 targets **Apple silicon (`arm64`) and macOS 27.0 or later**. The release was qualified while macOS 27 and Xcode 27 were in Release Candidate phase, so the GitHub distribution is a pre-release.
